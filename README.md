...
<p align=center>
  Figure 1: The System structure of DEFN.
</p>

### [Project page](https://github.com/IIPL-HangzhouDianziUniversity/DEFN-Pytorch) | [Paper]()

DEFN: Dual-Encoder Fourier Group Harmonics Network for Three-Dimensional Macular Hole Reconstruction with Stochastic Retinal Defect Augmentation and Dynamic Weight Composition.<br>
...
DEFN is a 3D OCT segmentation network for eye diseases with unobvious characteristics and easy to be interfered with, such as macular hole and macular edema.
